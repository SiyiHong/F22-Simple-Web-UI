"use strict";
(self["webpackChunkclass_ui"] = self["webpackChunkclass_ui"] || []).push([["polyfills"],{
...
function compileDeclareClassMetadata(metadata) {
  ...
  definitionMap.set('version', literal('14.2.3'));
...
function createDirectiveDefinitionMap(meta) {
  ...
  definitionMap.set('version', literal('14.2.3')); // e.g. `type: MyDirective`
